...
\Keyword{1}{API RESTful}{RESTful API}
\Keyword{2}{Sistema de informação para bubalinocultura}{Buffalo herd information system}
\Keyword{3}{Manejo de rebanho}{Herd management}
\Keyword{4}{Random Forest Regressor}{Random Forest Regressor}
\Keyword{5}{Produção de leite}{Milk production}
